---
name: review
description: Review recent changes against DESIGN.md and AGENTS.md for alignment
---

Review the current uncommitted or recently committed changes for quality and alignment with the project direction.

1. Read DESIGN.md and AGENTS.md to understand the project constraints and anti-patterns.
...
3. Check each change against:
   ...
   - Does it violate any anti-patterns listed in AGENTS.md?
   - Does it introduce unnecessary complexity or feature bloat per DESIGN.md §7?
   - Is the code consistent with the conventions in AGENTS.md?
